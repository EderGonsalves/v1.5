...
import type { Connections } from "@/lib/validations";

type ConnectionsSectionProps = {
  data?: Connections;
  institutionId?: number;
  onChange: (data: Connections) => void;
};
...
export const ConnectionsSection = ({
  ...
  const whatsAppConnected = data?.whatsApp?.connected ?? false;
  ...
  const handleWhatsAppConnect = () => {
    ...
    const oauthUrl = buildWhatsAppOAuthUrl(institutionId);
